const CACHE_NAME = 'kejian-pwa-v4';
const APP_SHELL = ['./','./index.html','./style.css','./importers.js','./appearance.js','./app.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
